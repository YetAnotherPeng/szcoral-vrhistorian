# -*- coding: utf-8 -*-
"""
Django settings for VRHistorian project.
...
ROOT_URLCONF = 'VRHistorian.urls'
MEDIA_ROOT=os.path.join(BASE_DIR, r'static/uploadfiles')
TEMPLATES_ROOT=os.path.join(BASE_DIR, r'static/templates')

WSGI_APPLICATION = 'VRHistorian.wsgi.application'
