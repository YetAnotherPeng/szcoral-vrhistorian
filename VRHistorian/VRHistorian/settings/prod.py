...
# python manage.py runserver --settings=VRHistorian.settings.prod_local
...
SECRET_KEY = os.environ.get("SECRET_KEY", '20l+bl6m!yl#h469uls2@-3drm=t+b9j-a7q79%32m0$)e@3hp')

# https://docs.djangoproject.com/en/2.2/ref/settings/#allowed-hosts
ALLOWED_HOSTS = ['139.9.91.62', ]
